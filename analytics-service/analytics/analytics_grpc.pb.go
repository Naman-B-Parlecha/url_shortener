...
func (c *analyticsServiceClient) GetAnalytics(ctx context.Context, in *ShortURL, opts ...grpc.CallOption) (*AnalyticsResponse, error) {
...
func (c *analyticsServiceClient) AddAnalytics(ctx context.Context, in *ShortURL, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, AnalyticsService_AddAnalytics_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AnalyticsService_GetAnalytics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalyticsServiceServer).GetAnalytics(ctx, req.(*ShortURL))
	}
...
func _AnalyticsService_AddAnalytics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(AnalyticsServiceServer).AddAnalytics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AnalyticsService_AddAnalytics_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalyticsServiceServer).AddAnalytics(ctx, req.(*ShortURL))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AnalyticsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AnalyticsService_AddAnalytics_Handler,
		},
	},
