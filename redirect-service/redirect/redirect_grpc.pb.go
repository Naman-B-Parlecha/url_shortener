...
const (
	RedirectService_GetRedirectURL_FullMethodName = "/redirect.RedirectService/GetRedirectURL"
)
...
type RedirectServiceClient interface {
	GetRedirectURL(ctx context.Context, in *ShortURL, opts ...grpc.CallOption) (*LongURL, error)
}
...
func (c *redirectServiceClient) GetRedirectURL(ctx context.Context, in *ShortURL, opts ...grpc.CallOption) (*LongURL, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LongURL)
	err := c.cc.Invoke(ctx, RedirectService_GetRedirectURL_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RedirectServiceServer interface {
	GetRedirectURL(context.Context, *ShortURL) (*LongURL, error)
...
func (UnimplementedRedirectServiceServer) GetRedirectURL(context.Context, *ShortURL) (*LongURL, error) {
...
func _RedirectService_GetRedirectURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShortURL)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RedirectServiceServer).GetRedirectURL(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RedirectService_GetRedirectURL_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RedirectServiceServer).GetRedirectURL(ctx, req.(*ShortURL))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _RedirectService_GetRedirectURL_Handler,
		},
	},
