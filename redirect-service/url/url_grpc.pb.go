...
const (
	URLService_GenerateShortURL_FullMethodName = "/url.URLService/GenerateShortURL"
...
type URLServiceClient interface {
	GenerateShortURL(ctx context.Context, in *LongURL, opts ...grpc.CallOption) (*ShortURL, error)
...
func (c *uRLServiceClient) GenerateShortURL(ctx context.Context, in *LongURL, opts ...grpc.CallOption) (*ShortURL, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ShortURL)
	err := c.cc.Invoke(ctx, URLService_GenerateShortURL_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type URLServiceServer interface {
	GenerateShortURL(context.Context, *LongURL) (*ShortURL, error)
...
func (UnimplementedURLServiceServer) GenerateShortURL(context.Context, *LongURL) (*ShortURL, error) {
...
func _URLService_GenerateShortURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: URLService_GenerateShortURL_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(URLServiceServer).GenerateShortURL(ctx, req.(*LongURL))
	}
